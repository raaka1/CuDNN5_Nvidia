...
INCLUDES += -IFreeImage/include -IUtilNPP
LIBRARIES += -LFreeImage/lib/$(TARGET_OS)/$(TARGET_ARCH) -LFreeImage/lib/$(TARGET_OS) -lcudart -lnppi -lnppc -lcublas -lcudnn -lfreeimage -lstdc++ -lm
